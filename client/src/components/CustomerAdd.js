    ...
    render() {
        return (
            <form onSubmit={this.handleFormSubmit}>
                ...
                생년월일: <input type="text" name="birthday" valeu={this.state.birthday} onChange={this.handleValueChage}/><br/>
                성별: <input type="text" name="gender" value={this.state.gender} onChange={this.handleValueChage}/><br/>
                직업: <input type="text" name="job" valeu={this.state.job} onChange={this.handleValueChage}/><br/>
